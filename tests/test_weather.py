...
def test_weather_date_generation_defaults_to_most_recent():
    ...
    assert weather._file_date(start=current_datetime) == expected_datetime
...
def test_weather_date_generation_can_step_back():
    ...
    assert weather._file_date(start=current_datetime, steps=2) == expected_datetime
...
def test_weather_image_filename_is_from_date():
    ...
    current_datetime = datetime.datetime(2016, 9, 6, 13, 14, 19)
